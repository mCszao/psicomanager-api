...
import com.psicomanager.api.user.mapper.UserMapper;
...
public class MyUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String input) {
        ...
        return userRepo.findByUsername(input)
                .orElseThrow(() -> new UserNotFoundException("Usuário ou senha incorretos"));
    }
    ...
    public void register(UserRegisterDTO dto) {
        ...
        if (userRepo.findByUsername(dto.username()).isPresent())
            throw new DuplicateUserEntryException("Esse usuário");
